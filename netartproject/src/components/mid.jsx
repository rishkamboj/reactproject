...
export function Mid(){
    ...
    <div style={{display:"flex",flexDirection:"row", gap:"20px"}}>
        <div><img src={toffy} style={{height:"510px"}}/></div>
        <div style={{display:"flex",flexDirection:"column"}}><b><h4 style={{marginBlockEnd:"unset"}}> C.R.I. PUMPS WINS THE NATIONAL ENERGY CONSERVATION AWARD 2018 for the 4th time.</h4></b>
        <ul>
